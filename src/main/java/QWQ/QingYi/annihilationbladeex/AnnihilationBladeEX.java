...
public class AnnihilationBladeEX {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> SLASHBLADE_TAB =
            ...
            .displayItems((parameters, output) -> {
                ItemStack bloodPrison = createBloodPrisonBlade(parameters.holders());
    ...
    public static ItemStack createBloodPrisonBlade(HolderLookup.Provider registries) {
        return BloodPrisonDefinitions.createStack(registries);
    }
