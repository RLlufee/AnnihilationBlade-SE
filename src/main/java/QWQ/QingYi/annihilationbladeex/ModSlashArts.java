...
public class ModSlashArts {
    ...
    public static final DeferredHolder<SlashArts, SlashArts> INFERNAL_SLAUGHTER = SLASH_ARTS.register("infernal_slaughter", () -> new SlashArts(entity -> ModComboStates.INFERNAL_SLAUGHTER_STATE.getId()).setProudSoulCost(0));
