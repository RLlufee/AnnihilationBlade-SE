...
public final class SpatialFractureExecutor {
    ...
    private static void spawnVerticalRing(ServerLevel level, Vec3 center, double radius, ParticleOptions particle,
                                          int points, boolean alongX) {
        for (int i = 0; i < points; i++) {
            double angle = Math.PI * 2.0D * i / points;
    ...
    private static void spawnParticleLine(ServerLevel level, Vec3 start, Vec3 end, ParticleOptions particle,
                                          int points, double jitter) {
        for (int i = 0; i <= points; i++) {
